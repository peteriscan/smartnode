...
type ExecutionConfigPage struct {
	...
	akulaItems      []*parameterizedFormItem
...
func (configPage *ExecutionConfigPage) createContent() {
	...
	configPage.akulaItems = createParameterizedFormItems(configPage.masterConfig.Akula.GetParameters(), configPage.layout.descriptionBox)
	...
	configPage.layout.mapParameterizedFormItems(configPage.akulaItems...)
...
func (configPage *ExecutionConfigPage) handleLocalEcChanged() {
	...
	case config.ExecutionClient_Akula:
		configPage.layout.addFormItemsWithCommonParams(configPage.ecCommonItems, configPage.akulaItems, configPage.masterConfig.Akula.UnsupportedCommonParams)
